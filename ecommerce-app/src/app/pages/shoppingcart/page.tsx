...
export default function Page() {
    ...
    const scrollRef = useRef<HTMLDivElement>(0); // Explicitly define the type of scrollRef
            ...
            <div className="grid grid-cols-12 md:mx-44">
                <div className="flex flex-col col-span-8 bg-slate-50 p-6 border-x-2 border-b-2 shadow-lg">
                    <div className="flex justify-between">
                        ...
                        <button className="rounded-md font-bold text-sm py-1 px-2 bg-slate-300">Update Shopping Cart</button>
                    </div>
