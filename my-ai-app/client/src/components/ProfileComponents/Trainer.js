        ...
        <div className="h-[60vh] md:h-auto mx-12 mt-6 flex flex-col">
            <div className=" flex flex-col-reverse">
                <div className="flex justify-evenly items-center">
                    <p className="text-5xl font-extrabold">{trainer.userName}</p>
            ...
            <div className="flex flex-col md:gap-56 gap-4 md:flex-row border-t md:mx-auto pt-4"> 
                <div className="flex flex-col">
                    ...
                    <p><span className="font-semibold">Name:</span> {trainer.firstName} {trainer.lastName}</p>
                    <p><span className="font-semibold">Number of Clients:</span> {trainer.clients.length}</p>
                </div>
                <Button 
                    size="lg"
                    className="mt-auto"
